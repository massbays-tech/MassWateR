...
This outlines how to propose a change to MassWateR. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("massbays-tech/MassWateR", fork = TRUE)`.
...
Code of
Conduct](https://massbays-tech.github.io/MassWateR/CODE_OF_CONDUCT.md).
