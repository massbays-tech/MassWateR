...
vignette: >
  %\VignetteIndexEntry{MassWateR Dashboard}
...
The dashboard is available as a companion R package, <a href="https://github.com/massbays-tech/MassWateRdash" target="_blank">MassWateRdash</a>.  Issues directly related to the dashboard and its use can be reported on that repository's <a href="https://github.com/massbays-tech/MassWateRdash/issues" target="_blank">issues page</a> (issues related to core features of the MassWateR package can be reported on the <a href="https://github.com/massbays-tech/MassWateR/issues" target="_blank">MassWateR issues page</a>). 
...
This opens the dashboard in your default web browser. Data are uploaded from your computer and all processing happens locally in your R session.

### Use the dashboard from a web browser

A hosted instance of the dashboard is also available directly in a browser:
...
This page is used to upload and format data used for the rest of the dashboard. Five types of data (six files) are used with the MassWateR package, described in the [Data input and checks](inputs.html) article.
...
```{r uploadimg, out.width = '100%', echo = F, fig.cap = 'The Upload & Validate tab.'}
knitr::include_graphics("dashboard_upload.png")
```

### 2. Outlier Assessment

This page is used to view potential outliers in the results data file, described in more detail in the [Outlier checks](outlierchecks.html) article.
...
```{r outlierimg, out.width = '100%', echo = F, fig.cap = 'The Outlier Assessment tab.'}
knitr::include_graphics("dashboard_outlier.png")
```

### 3. QC Reporting

This page is used to view the quality control information for the results data file, using information from the data quality objectives that describe quality control accuracy, frequency, and completeness. See the [Quality control](qcoverview.html) article for detailed information on the quality control methods and results.

The page includes six sub-tabs:

1. **DQO tables**: View tables for the **frequency & completeness** and **accuracy** data quality objectives. These are the same files imported on the first page.
...
6. **Report**: Download a complete quality control report as a Word document. This report includes all tables in this page.

```{r qcimg, out.width = '100%', echo = F, fig.cap = 'The QC Reporting tab.'}
knitr::include_graphics("dashboard_qc.png")
```

### 4. WQX Output

This page is used to view your data formatted for upload to the Water Quality Exchange (WQX) portal. See the [Water Quality Exchange output](wqx.html) article for detailed information on the results and how to upload to WQX.

The page includes four sub-tabs:

1. **Projects**: View a table showing project information from your results file formatted for WQX upload.
2. **Locations**: View a table showing site locations from your results and site files formatted for WQX upload.
3. **Results**: View a complete water quality file formatted for WQX upload.
4. **Workbook**: Download a complete WQX Excel workbook. This file includes all tables in this page.
...
```{r wqximg, out.width = '100%', echo = F, fig.cap = 'The WQX Output tab.'}
knitr::include_graphics("dashboard_wqx.png")
```

### 5. Visualize

This page is used to visualize results from your input data files. See the [Analyses](analysis.html) article for detailed information on the plots and methods used to create them.
...
1. **Season**: View monthly results for a single parameter using boxplots or barplots.
...
```{r visualizeimg, out.width = '100%', echo = F, fig.cap = 'The Visualize tab.'}
knitr::include_graphics("dashboard_visualize.png")
```
