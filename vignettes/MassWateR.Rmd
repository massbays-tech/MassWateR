...
Five types of data are used with the MassWateR package: surface water quality results, data quality objectives (for accuracy, frequency, and completeness), site metadata, wqx metadata, and censored data (optional).
