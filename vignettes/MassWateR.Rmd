...
Example files included with the package are imported for demonstration in this vignette. Your data import code will look more like the code chunk above.
