...
Templates and instructions for each of the types of input data are available for download in the [Resources tab](https://massbays-tech.github.io/MassWateR/RESOURCES.html). Additionally, example files, described below, are provided with the package to demonstrate and test the functions.
