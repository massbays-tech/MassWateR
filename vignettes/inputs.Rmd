...
5. Information on the number of **censored** or missing observations by parameter.  This is optional and used only for the QC report created by `qcMWRreview()`, specifically for the quality control completeness checks in the table produced by `tabMWRcom()`.
