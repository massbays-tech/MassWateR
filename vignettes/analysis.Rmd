...
logical indicating if fecal indicator data have sites grouped separately by result attributes, applies only if `param` is `"E.coli"`, `"Enterococcus"`, or `"Fecal Coliform"`.
