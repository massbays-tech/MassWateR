...
A map of dissolved oxygen averages across all dates can be created as follows. The required inputs are the results data, the data quality objective file for accuracy, and the site metadata file with the site locations. These can be passed to the function with the separate arguments or as a named list using the `fset` argument. The warning message indicates some sites in the results file do not have spatial data in the site metadata file.
