...
```{r, fig.height = 4, fig.width = 8}
anlzMWRseason(res = resdat, param = "DO", acc = accdat, thresh = "fresh", group = "week", type = "box", jitter = TRUE)
```
...
```{r, fig.height = 4, fig.width = 8}
anlzMWRseason(res = resdat, param = "E.coli", acc = accdat, thresh = "fresh", group = "month", site = "ABT-077", resultatt = "Dry")
```
