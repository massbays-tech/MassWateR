...
Below, the `qcMWRfre()` function is executed with the data frames for the results and quality objectives file for frequency and completeness.  The warnings and checks are suppressed. 
