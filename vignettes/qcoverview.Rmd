...
Below, the `qcMWRcom()` function is executed with the data frames for the results and quality objectives file for completeness.  The warnings and checks are suppressed. 
