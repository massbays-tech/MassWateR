...
A summary table showing the total number of records, the total number of qualified records, and percent completeness (the difference between the two) can be created with `tabMWRcom()`.  The `% Completeness` column shows cells as green or red if the required percentage of observations for completeness are present as specified in the data quality objectives file. The function is also executed with the data frames from above, since they have already passed the internal checks. 
